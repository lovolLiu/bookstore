						...
						$.ajax({
							...
							success:function(data){
								$.each(data,function(i,list){  
                       				 ...
                       				 +"<td class=\"cart_product\"><input onclick='OnClickCheckBox(" + list.buyItemID + ")' type=\"checkbox\" class=\"itemselectbox\" name=\"buyItemIDList\" value=\"" + list.buyItemID + "\"><a href='BookDetail?id=" + list.bookID  + "'><img src=\""+list.imageUrl+"\"></a></td>"
									 ...
									 +"<td class=\"cart_total\"> <p class=\"cart_total_price\"> ¥<span class='cart_span'>"+list.buyItemPrice+"</span></p></td>"
