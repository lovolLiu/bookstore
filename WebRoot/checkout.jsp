				...
				<div class="row">
					...
					<div class="col-sm-4">
						<div class="order-message">
							<p>备注</p>
							<textarea name="message"  placeholder="注明特殊的投递需求以及包装要求。" rows="16"></textarea>
						</div>	
					</div>					
				</div>
			</div>
							...
							<td colspan="2">
								<table class="total-result">
									...
									<tr style="border-bottom: 0;">
										<td></td>
										<td><div style="text-align: right;"><a class="btn btn-default check_out" href="pay.jsp">提交订单</a></div></td>
									</tr>
								</tbody></table>
							</td>
						</tr>
