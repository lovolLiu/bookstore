			...
			<div class="sap_tabs">
				...
				<div id="horizontalTab"
						...
						<div class="register">
							<form action="Login">
								<input placeholder="用户名" class="mail" type="text" required=""
									name="username"> <input placeholder="密码" class="lock"
									type="password" required="" name="password"> <input
					...
					<div class="tab-2 resp-tab-content" aria-labelledby="tab_item-1">
						<div class="register">
							<form>
								<input id="usrname" placeholder="用户名" type="text" required=""
									onblur="checkusrname()">
		...
		function checkusrname() {
			...
			$.ajax({
				...
				success : function(data) {
					if (data == "exist") {
						$("#errorusrname").html("您的用户名已存在，请更换一个");
						flag = false;
					} else if (data == "noexist") {
						$("#restore-success").html("");
						flag = true;
					}
				}
			});
