		...
		<div class="lib-related-products">
			...
			<section class="lib-categories-section">
				<div class="container">
					...
					<!--SECTION CONTENT END-->
					<ul class="nav nav-tabs" role="tablist">
						<li role="presentation" class="active"><a href="#Photography"
							role="tab" data-toggle="tab">艺术 &amp; 摄影</a></li>
						<li role="presentation"><a href="#Biographies" role="tab"
							data-toggle="tab">自传 &amp; 回忆录</a></li>
						<li role="presentation"><a href="#Business" role="tab"
							data-toggle="tab">商业</a></li>
						<li role="presentation"><a href="#Computers" role="tab"
							data-toggle="tab">电脑 &amp; 网络</a></li>
					</ul>
						...
						<div role="tabpanel" class="tab-pane fade in active"
							...
							<ul class="bxslider">
								<li>
									...
									</div> <!--PRODUCT GRID END--> <!--PRODUCT GRID START-->
									<div class="col-md-3 col-sm-6 best-seller-pro">
										<figure>
							...
							<div role="tabpanel" class="tab-pane fade" id="book6">
								<div class="lib-papular">
									...
									<div class="kode-text">
										...
										<p>Legions of readers entranced by Twilight are hungry for
											more and they won't be disappointed. In New Moon, Stephenie
											Meyer delivers another irresistible combination of romance
											and suspense with a supernatural twist. The "star-crossed"
											lovers theme continues as Bella and Edward find themselves
											facing new obstacles that will enable them to contribute to
											innovation in the workplace families a life of safety.</p>
										<div class="lib-price">
											<h3>$630</h3>
											<a href="#">See More</a>
										</div>
